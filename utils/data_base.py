...
from neuralpredictors.utils import no_transforms
from neuralpredictors.data.exceptions import DoesNotExistException, InconsistentDataException
from neuralpredictors.data.transforms import DataTransform, Invertible, Delay, MovieTransform, Subsequence
from neuralpredictors.data.utils import zip_dir
...
class FileTreeDatasetBase(TransformDataset):
    ...
    def __init__(self, dirname, *data_keys, transforms=None, use_cache=True, output_rename=None, output_dict=True):
        """
